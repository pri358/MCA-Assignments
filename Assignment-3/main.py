...
if __name__ == '__main__':
	...
	for i in range(10):
		sim_matrix = relevance_feedback(vec_docs, vec_queries, sim_matrix, gt)
		rf_sim_matrix = sim_matrix
		if args.verbose:
	...
	for i in range(10):
		sim_matrix = relevance_feedback_exp(vec_docs, vec_queries, sim_matrix, tfidf_model, gt)
		rf_sim_matrix = sim_matrix
		if args.verbose:
			for i in range(rf_sim_matrix.shape[1]):
				ranked_documents = np.argsort(-rf_sim_matrix[:, i])
